...
!!$  write(gmdir,'(a)') "/data9/blaizot/256-100h-1Mpc/DBGM/"
  nsteps = 20
  nruns  = 111
!!$  write(dbdir,'(a)') "/data/garel/GM-RUNS/512-100h-1Mpc-W3/kenn_sfr/sf20_feedB002_best2/Snapshots/"
!!$  write(gmdir,'(a)') "/data/garel/GM-RUNS/512-100h-1Mpc-W3/kenn_sfr/sf20_feedB002_best2/"
  write(dbdir,'(a)') "/simu1/data2/garel/GM-RUNS/1024-100h-1Mpc-W3/kenn_sfr/sf20_fd025_wind_corr/Snapshots/"
  write(gmdir,'(a)') "/simu1/data2/garel/GM-RUNS/1024-100h-1Mpc-W3/kenn_sfr/sf20_fd025_wind_corr/"
