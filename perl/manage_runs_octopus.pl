...
my $treeDir      = "/simu3/garel/W5-100h-1Mpc_thibault_z0/DM-LSS-1024/TreeMaker200/";
my $treeFileMin  = 1;
my $treeFileMax  = 177;
...
my $gmDir        = "/simu3/garel/GM-RUNS/1024-100h-1Mpc-W5/NewSimu_z0/sf5_zmigr_newFilters2_HALOS/";
...
# --- WMAP5-100Mpc simulations (Komatsu+09) ----
    ...
    print FILE "inputpath      = /simu3/garel/Inputs_GM/ \n";
#    print FILE "filterpath     = /data/blaizot/Filters/ \n";
    print FILE "filterpath     = /simu3/garel/Filters_tibo/ \n";
...
#    print FILE "momaf_snap_dir = /data/garel/GM-RUNS/512-100h-1Mpc-W3/kenn_sfr/sf20_feedB002_best3/momaf_cone/ \n";
    print FILE "nsteps_do      = 21   ! number of timesteps to compute \n"; #25
